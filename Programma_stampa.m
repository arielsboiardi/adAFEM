...
method.maxResLoc=1e-2; % Massimo errore su ogni elemento della partizione

method.maxRes=1e-6; % Massimo errore globale

method.maxIter=10; % Massimo numero di iterazioni dell'algoritmo adattivo
...
%% Soluzione finale
% Presentiamo all'utente la soluzione finale ottenuta.

% Visualizza la soluzione finale
plot(spacef.T,uh) 

visnodi=input("Vuoi vedere i nodi della partizione finale? s/n\n",'s');
if visnodi=='s'
    hold on
